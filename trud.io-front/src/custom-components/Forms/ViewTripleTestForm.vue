    ...
    <form-row>
      <div class="col-6">
        <text-input
          ...
          :value="risk(tripleTest.trisomy21)"
          type="text"
          :disabled="true"
        />
      </div>
      <div class="col-6">
        <text-input
          ...
          :value="result(tripleTest.resultT21)"
          type="text"
          :disabled="true"
        />
      </div>
    ...
    <form-row>
      <div class="col-6">
        <text-input
          ...
          :value="risk(tripleTest.trisomy13)"
          type="text"
          :disabled="true"
        />
      </div>
      <div class="col-6">
        <text-input
          ...
          :value="result(tripleTest.resultT13)"
          type="text"
          :disabled="true"
        />
      </div>
    ...
    <form-row>
      <div class="col-6">
        <text-input
          ...
          :value="risk(tripleTest.trisomy18)"
          type="text"
          :disabled="true"
        />
      </div>
      <div class="col-6">
        <text-input
          ...
          :value="result(tripleTest.resultT18)"
          type="text"
          :disabled="true"
        />
      </div>
